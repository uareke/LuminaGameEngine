...
```bash
git clone https://github.com/seu-usuario/lumina-engine.git
cd lumina-engine
```
...
- **Bugs**: Abra uma [issue](https://github.com/seu-usuario/game-engine-estado/issues)
- **Features**: Sugira no [discussions](https://github.com/seu-usuario/game-engine-estado/discussions)
...
![Commits](https://img.shields.io/github/commit-activity/m/seu-usuario/lumina-engine)
![Issues](https://img.shields.io/github/issues/seu-usuario/lumina-engine)
